...
-->
                            ...
                            <div class="col-md-5" style="padding-top: 5px;">
                                <div class="alert alert-success text-center">
                                    <p style="font-size: 12px;"><a href="#end"> برای امتیاز دهی به این مرکز کلیک
                                            کنید</a></p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row" style="padding: 10px;">
            ...
            <div class="col-md-2" style="display: inline-block; margin: 10px; float: right; ">
            ...
            <div class="col-md-10" style="display: inline-block; margin:36px 52px">

                <span class="glyphicon glyphicon-calendar"></span>
                <span class="caption-subject bold uppercase">برنامه ی:
                            <span class="week_title">
                              @if($set_week > $current_weekM6)
                                    <a href="/centers/{{ $reservable_center->id}}/week/{{ $set_week->id - 1 }}"><i
                                                class="glyphicon glyphicon-hand-right" style="font-size: 25px;"
                                                title="هفته قبل"></i></a>
                                @endif
                                {{ $lingual_set_week }}
                                <a href="/centers/{{ $reservable_center->id}}/week/{{ $set_week->id + 1 }}"><i
                                            class="glyphicon glyphicon-hand-left" style="font-size: 25px;"
                                            title="هفته بعد"></i></a>
                            </span>
                          </span>
        ...
        <ul class="nav nav-tabs" style="    float: right;">
            @foreach($reservable_center->room as $room)
                ...
                <li @if($i==1) class="active" @endif><a data-toggle="tab" href="#br<?=$i ?>">اتاق: {{ $room->name }}
                        -{{$room->size}}متری</a></li>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <h3 class="caption-subject bold uppercase">اتاق: {{ $room->name }}</h3>
                                    </div>
                                </div>
                                ...
                                <div class="portlet-body">
                                    <div class="row" style="margin-bottom: 15px;">
                                            ...
                                            @if(count($room->image)>0)
                                                <div id="slideshow-{{$room->id}}" class="carousel slide"
                                                    ...
                                                    <a class="left carousel-control" href="#slideshow-{{$room->id}}"
                                                       role="button" data-slide="next" style="margin-left: 25px">
                                        ...
                                        <div class="col-md-6 btn-info" style="border-radius: 50px;padding: 10px 30px;">
                                            ...
                                            @if ($room->sandali)
                                                <span>تعداد صندلی : </span> <span><b> {{ $room->sandali }}
                                                        نفر </b></span><br/>
                                            @endif
                                    ...
                                    <div class="col-md-12 touch hidden-lg hidden-md" style="overflow-x: scroll ">
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column "
                                               id="sample_1" style=" display: block;">
                                            <!--
                                              <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="12"
                                                    style="text-align: center !important; background-color: #F4C20B;color: white;">
                                                    صبح
                                                </th>
                                                <th colspan="12"
                                                    style="text-align: center;background-color: #1d4f8e;color: white;">
                                                    بعداز
                                                    ظهر
                                                </th>
                                            </tr>
                                            ...
                                            @foreach($day_mapper as $dmkey => $dm)
                                                <tr class="odd gradeX">
                                                    ...
                                                    @if(compare_with_today(date_day_plus($set_week->start_date,$dmkey)))
                                                        @for($i=0;$i<24;$i++)
                                                            <th class="box room_{{ $room->id }} timing_unsellable"
                                                                data-roomid="{{$room->id}}" data-day="{{$dmkey }}"
                                                                data-hour="{{ $i }}"
                                    ...
                                    <div class="col-lg-12 touch hidden-sm hidden-xs">
                                        ...
                                        <table class=" table  table-responsive table-striped table-bordered table-hover table-checkable order-column"
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="12"
                                                    style="text-align: center;background-color: #F4C20B;color: white;">
                                                    صبح
                                                </th>
                                                <th colspan="12"
                                                    style="text-align: center;background-color: #1d4f8e;color: white;">
            ...
            <div class="row" style="padding-button:10px;margin:1px;">
                <form method="get" id="order_form" action="/order/set">
                    ...
                    <div class="row" style="text-align:center;">
                        <button class="btn btn-lg  btn-success" id="room_timing_reserve" type="button"
                                style="width: 30%;margin-bottom: 15px;">رزرو
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <!-- BEGIN EXAMPLE TABLE PORTLET-->
            <div class="portlet light well" style="padding-right: 100px">
                ...
                <div class="row">
                    <div class="col-xs-12">
                    <div class="portlet-body well" style="text-align: center;">
                        <p>در بخش فوق میتوانید زمان های خالی و اطلاعات اتاق های این مرکز را
                            مشاهده کنید.<br/>
                        ...
                        <p style="text-align: right;"><span style="color: #ff0000;">توضیحات</span>: ساعاتی که به رنگ سبز
                            نمایش داده شده قابل رزرو می باشد و شما با کلیک بر روی ساعات مورد نظر و فشردن کلمه ی رزرو در
                            انتهای صفحه میتوانید به مرحله ی تایید و پرداخت ساعات رزرو مورد نظرتان بروید.</p>
                    </div>
                    </div>
                </div>
            </div>
                                ...
                                @if($Comment->count()>0)
                                    ...
                                    @foreach($Comment as $key=>$value)
                                        <div style="margin:auto;width:98%;box-shadow: 0 2px 3px rgba(0, 0, 0, 0.15);border-radius: 20px">
                                            <div style="height: 37px;line-height: 37px;background: #e8e9eb;padding: 0 2px;border-radius: 2px 2px 0 0;font-size:12px;">
                                                <span>ارسال شده توسط : </span>
                                                <span>{{ $value['name'] }}</span><span> - </span> {{ $jdf->jdate('Y/n/j',$value['time'])  }}
                                            </div>
                                            ...
                                            @foreach($parent as $key1=>$value1)
                                                ...
                                                <div style="width:92%;margin:auto">
                                                    ...
                                                    <p style="font-size:10px;padding-top:15px;color: #3FB8AF"><span>ارسال شده توسط : </span>
                                                        <span>{{ $value1['name'] }}</span><span> - </span>{{ $jdf->jdate('Y/n/j',$value1['time'])  }}
                                                    </p>
                                        ...
                                        <div style="width:98%;margin:auto"><p
                                                    style="padding-right:10px;color:red;font-size:13px;padding-top:2px;cursor:pointer;padding-bottom:10px;"
                                                    onclick="add_answer('<?= $value['id'] ?>','<?= $value['name'] ?>')">
                                                ارسال پاسخ به اين نظر</p></div>

                                    @endforeach

                                    <div style="width:100%;height:40px;background:#ffffff;padding-right:15px">{{ $Comment->render() }}</div>
                                @else
                                    <p style="color:red;text-align:center;padding-top:0px;padding-bottom:50px;">تا کنون
                                        نظری برای این مرکز ثبت نشده است</p>
                                @endif
...
-->
                                    ...
                                    <form method="post" action="{{ url('user/add_comment') }}">
                                        ...
                                        <input type="hidden" name="parent_id" value="0" id="answer"/>
                                        <div class="form-group">
                                            <label for="name"><span style="padding:4px;"
                                                                    class="glyphicon glyphicon-user"></span>نام:</label>
                                            <input type="text" class="form-control" id="name" required="required"
                                                   placeholder=" نام خود را وارد نمایید" name="name"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1"><span style="padding:4px;"
                                                                                           class="glyphicon glyphicon-comment"></span>نظر:
                                            </label>
                                            <textarea class="form-control" name="comment" id="comment" rows="3"
                                                      required="required"
                                                      placeholder="نظر خود را واردنمایید"></textarea>
