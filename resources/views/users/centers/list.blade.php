            ...
            <div class="row">
                <div class="portfolio-content portfolio-4">
                    <div id="js-filters-full-width" class="cbp-l-filters-alignCenter">
                        ...
                        <div class="row">
                            <div class="col-xs-12  col-md-2 col-md-offset-5" id="advsearch"
                                 style="padding-bottom:15px;padding-top:5px;">
                                <button class="btn btn-success" onclick="myFunction()" style="border-radius:5px;">نمایش
                                    باکس سرچ
                                    پیشرفته
                                </button>
                        ...
                        <div class="panel panel-success" id="myDIV" style="display: none;">
                            <div class="panel-heading text-center" onclick="myFunction()"> جســـتجــوی پیـشـــرفتــه
                                <span
                                    ...
                                    <div class="row" style="padding-bottom: 20px;padding-top: 20px;">
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group" style="text-align: center;">
                                                ...
                                                <input type="text" placeholder="انتخاب روز" class="form-control"
                                                       value="{{$today_date}}" name="rooz" id="datepicker">
                                                @if ($errors->has('rooz'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id='datetimepicker3' data-align="top" data-autoclose="true">
                                                    ...
                                                    <input name="time" type="time" class="form-control"
                                                           value={{date('H:i', strtotime('+3 hours'))}} required>
                                                    @if ($errors->has('time'))
                                                        <span class="help-block" style="color: red;">
                                        ...
                                        <div class="col-xs-4">
                                            <div class="form-group">
                                                ...
                                                <div id='datetimepicker3' data-align="top" data-autoclose="true">
                                                    ...
                                                    <input name="endtime" type="time" class="form-control" value='23:00'
                                                           required>
                                        ...
                                        <div class="col-xs-6 " style="direction:rtl;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="مبلغ به تومان"
                                                       name="money" min="1000" value="10000" step="1000">
                                                @if ($errors->has('money'))
                                                    <span class="help-block" style="color: red;">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group" style="text-align: center;">
                                                ...
                                                <input type="text" name="name" class="form-control "
                                                       placeholder="نام پلاتو مورد نظر">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col-xs-6 ">
                                                <div class="form-group-lg">
                                                    ...
                                                    <select class="selectpicker form-control" name="attribute[]"
                                                            multiple
                               ...
                               -->
                                            ...
                                            <div class="col-xs-6 " style="direction:rtl;  padding-bottom: 15px;">
                                                <div class="form-group-lg">
                                                    ...
                                                    <select class="selectpicker form-control" name="size"
                                                            data-live-search="true" data-size="6"
                                                            title="انتخاب اندازه اتاق   ">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3" style="direction: rtl; border-radius: 3px;">
                            <div class="thumbnail" style="border-radius:8px;background-color:#ebeff0;">
                                <div style="height:150px;width:100%;">
                                    <a href="{{ route('user.panel.detailCenter',$rs->id) }}">
                                        <img class="img-responsive" style="height:100%;width: 100%;"
                                             src="@if(!empty($rs->image)) /images_thumb/{{ $rs->image->picture }} @else /img/default.gif @endif"
                                             alt="">
                                    </a>
                                ...
                                <div class="caption">
                                    <a href="{{ route('user.panel.detailCenter', $rs->id) }}">
                                        <h5 style="color: #00c4ff"><span
                                                    style="font-weight: bold;"> {{ $rs->name}} </span></h5>
                                    </a>
                                    <p><span class="glyphicon glyphicon-tag"></span> نوع مرکز
                                        :{{ $rs->center_type->name }} </p>
                                ...
                                {{ $ca->name }}
                                    ...
                                    <p style="direction:rtl;">
                                        <span class="fa fa-2x fa-map-marker text-green text-bold"
                                              style="color: red;"></span>
                                        <small class="no-margin"
                                               style="display: block; height: 50px; overflow-y: auto;">
                                    ...
                                    <p style="height: 60px;">
                                        @if(!empty($reservable_center_not_selled))
                                            ...
                                            @if(!in_array($rs->id,$reservable_center_not_selled))
                                                <span class="btn btn-danger">اتاق خالی موجود نیست</span>
                                            @endif
                                    ...
                                    <p>
                                        <a href="{{ route('user.panel.detailCenter',$rs->id) }}" class="btn btn-sm btn-success"
