    ...
    $(document).ready(function(){
        $("#hs").click(function(){
				...
				if(text=='جستجو پیشرفته'){
					$(this).text('جستجو ساده');
				}
				if(text=='جستجو ساده'){
					$(this).text('جستجو پیشرفته');
				}
...
<!----start-search-box----->
    ...
    <div class="row">
        <div class="col-xs-12  col-md-2 col-md-offset-5 text-center"  style="padding-bottom: 20px;padding-top:5px;">
            <button class="btn btn-info" id="hs" style="background-color:#21eaea;">جستجو پیشرفته</button>
    ...
    <div class="row" id="advsearch"  style="display: none;">
        <div class="panel panel-success">
                        ...
                        <div class="col-xs-4 ">
                            <div class="form-group">
                                ...
                                <div  id='datetimepicker3' data-align="top" data-autoclose="true" >
                                    ...
                                    <input   name="time" type="time" class="form-control" step="3600" value={{date('H:00', strtotime('+3 hours'))}} required>
                                    @if ($errors->has('time'))
                                        <span class="help-block"  style="color: red;">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <div   id='datetimepicker3' data-align="top" data-autoclose="true" >
                                    ...
                                    <input   name="endtime" type="time" step="3600" class="form-control" value='23:00' required>
