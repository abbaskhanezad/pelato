...
$(function () {
  ...
  var $tabButton = $('<li />', { 'class': 'active' })
    .html('<a href=\'#control-sidebar-theme-demo-options-tab\' class=\'kir-abbasi-2\' data-toggle=\'tab\'>'
  ...
  $demoSettings.append(
    ...
    + '<input type="checkbox"data-layout="fixed"/> '
    + '<span> قالب فیکس </span>'
    + '</label>'
    + '<p class="text-justify">فیکس شدن قالب. نمیتوانید قالب فیکس و باکس را همزمان انتخاب کنید</p>'
    + '</div>'
    // Boxed layout
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    ...
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-sidebarskin="toggle"/> '
    + 'قالب سایدبار چپ'
    + '</label>'
